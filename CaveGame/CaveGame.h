...
class CaveGame : public GameState{
	private:
		int intoxication, health, koalaX, floorY, ceilY, koalaHeight, koalaWidth, time, timeDone, caveSpeed, objW[10][3], objH[10][3], 
			objFreq[10], objFrames[10][3]; //10 types of obj, max of 50 per level
		float koalaVx, momentumX, koalaVy, momentumY, koalaY, objX[10][8], objY[10][8], objVx[10], objVy[10];
