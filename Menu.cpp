...
void Menu::Render(){
	...
	if(selected == LEAF_PUNCH)al_draw_text(font36, al_map_rgb(0,0,255), x, tempY, ALLEGRO_ALIGN_CENTRE, "Play Game");
		else al_draw_text(font36, al_map_rgb(255,0,255), x, tempY, ALLEGRO_ALIGN_CENTRE, "Play Game");
	tempY += fontHeight;
	...
	al_draw_textf(font36, al_map_rgb(100,10,100), 15, 90, 0, "h: %i w: %i", mouseX, mouseY);
}